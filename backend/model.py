...
# MODEL_PATH = os.path.join(BASE_DIR, "trained_model", "tempo_model.keras")
# CSV_PATH = os.path.join(BASE_DIR, "data", "tempo_dataset.csv")

# def train_model(csv_path=CSV_PATH, epochs=20, test_split=0.2):
#     """
...
import tensorflow as tf
from tensorflow.keras import layers, models
from backend.midi_features import extract_features  # ✅ updated import
